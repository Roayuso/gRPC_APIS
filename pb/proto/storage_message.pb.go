...
var file_proto_storage_message_proto_rawDesc = []byte{
	...
	0x0a, 0x03, 0x53, 0x53, 0x44, 0x10, 0x02, 0x42, 0x09, 0x5a, 0x07, 0x70, 0x62, 0x2e, 0x72, 0x61,
...
func file_proto_storage_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_storage_message_proto_msgTypes[0].Exporter = func(v any, i int) any {
