...
type GetLaptopStoreRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetLaptopStoreRequest) Reset() {
	*x = GetLaptopStoreRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetLaptopStoreRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLaptopStoreRequest) ProtoMessage() {}

func (x *GetLaptopStoreRequest) ProtoReflect() protoreflect.Message {
	mi := &file_proto_laptop_service_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLaptopStoreRequest.ProtoReflect.Descriptor instead.
func (*GetLaptopStoreRequest) Descriptor() ([]byte, []int) {
	return file_proto_laptop_service_proto_rawDescGZIP(), []int{2}
}

type GetLaptopStoreResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetLaptopStoreResponse) Reset() {
	*x = GetLaptopStoreResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetLaptopStoreResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLaptopStoreResponse) ProtoMessage() {}

func (x *GetLaptopStoreResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_laptop_service_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLaptopStoreResponse.ProtoReflect.Descriptor instead.
func (*GetLaptopStoreResponse) Descriptor() ([]byte, []int) {
	return file_proto_laptop_service_proto_rawDescGZIP(), []int{3}
}

func (x *GetLaptopStoreResponse) GetLaptops() []*Laptop {
	if x != nil {
		return x.Laptops
	}
	return nil
...
var file_proto_laptop_service_proto_rawDesc = []byte{
	...
	,
	...
	0x69, 0x7a, 0x65, 0x32, 0xd1, 0x01, 0x0a, 0x0d, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x53, 0x65,
	...
	0x73, 0x65, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0b, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x49, 0x6d,
	...
	0x28, 0x01, 0x12, 0x43, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x53,
	0x74, 0x6f, 0x72, 0x65, 0x12, 0x16, 0x2e, 0x47, 0x65, 0x74, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70,
	0x53, 0x74, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x47,
	0x65, 0x74, 0x4c, 0x61, 0x70, 0x74, 0x6f, 0x70, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x70, 0x62, 0x2e, 0x72, 0x61,
	0x79, 0x75, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_laptop_service_proto_goTypes = []any{
	...
	(*GetLaptopStoreRequest)(nil),  // 2: GetLaptopStoreRequest
	(*GetLaptopStoreResponse)(nil), // 3: GetLaptopStoreResponse
...
var file_proto_laptop_service_proto_depIdxs = []int32{
	...
	7, // 1: GetLaptopStoreResponse.laptops:type_name -> Laptop
	5, // 2: UploadImageRequest.info:type_name -> ImageInfo
	0, // 3: LaptopService.CreateLaptop:input_type -> CreateLaptopRequest
	4, // 4: LaptopService.UploadImage:input_type -> UploadImageRequest
	2, // 5: LaptopService.GetLaptopStore:input_type -> GetLaptopStoreRequest
	1, // 6: LaptopService.CreateLaptop:output_type -> CreateLaptopResponse
	6, // 7: LaptopService.UploadImage:output_type -> UploadImageResponse
	3, // 8: LaptopService.GetLaptopStore:output_type -> GetLaptopStoreResponse
...
func file_proto_laptop_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_laptop_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*GetLaptopStoreRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_laptop_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
			switch v := v.(*GetLaptopStoreResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
