...
var file_proto_processor_message_proto_rawDesc = []byte{
	...
	0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x42, 0x09,
	0x5a, 0x07, 0x70, 0x62, 0x2e, 0x72, 0x61, 0x79, 0x75, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
...
func file_proto_processor_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_processor_message_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*CPU); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_processor_message_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*GPU); i {
			case 0:
				return &v.state
			case 1:
